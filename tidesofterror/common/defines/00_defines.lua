...
NGame = {
	...
	END_DATE = "1874.1.1.1",
	MAP_SCALE_PIXEL_TO_KM = 0.004,					-- Yes, we did the math orignally 7.114 with global earth. britain map is 0.004. divide any normal globe value by 1778.5 to get britain scale
