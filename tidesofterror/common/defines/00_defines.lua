...
NMilitary = {
	...
	LAND_SPEED_MODIFIER = 0.2,                    -- basic speed control
...
NNavy = {
	...
	NAVAL_SPEED_MODIFIER = 0.07,	                    				-- basic speed control
...
NFocus = {
	FOCUS_POINT_DAYS = 5,						-- Each point takes a week
